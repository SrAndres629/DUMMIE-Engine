...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `layers/l0_overseer/lib/overseer/application.ex` | L0 | DEFERRED_NO_SAFE_ACTION->DEFERRED_NO_SAFE_ACTION | HIGH->HIGH | 3 | 0 | none |
...
| `layers/l1_nervous/internal/skill/blueprint.go` | L1 | DEFERRED_NO_SAFE_ACTION->DEFERRED_NO_SAFE_ACTION | HIGH->HIGH | 3 | 0 | none |
| `layers/l1_nervous/internal/skill/mcp_client.go` | L1 | DEFERRED_NO_SAFE_ACTION->DEFERRED_NO_SAFE_ACTION | HIGH->HIGH | 3 | 0 | none |
| `layers/l1_nervous/internal/skill/types.go` | L1 | DEFERRED_NO_SAFE_ACTION->DEFERRED_NO_SAFE_ACTION | HIGH->HIGH | 3 | 0 | none |
...
| `layers/l1_nervous/sidecar.go` | L1 | DEFERRED_NO_SAFE_ACTION->DEFERRED_NO_SAFE_ACTION | HIGH->HIGH | 3 | 0 | none |
| `layers/l1_nervous/ssh_sandbox_wrapper.sh` | L1 | DEFERRED_NO_SAFE_ACTION->DEFERRED_NO_SAFE_ACTION | HIGH->HIGH | 3 | 0 | none |
| `layers/l1_nervous/tools_impl/nervous.py` | L1 | DEFERRED_NO_SAFE_ACTION->DEFERRED_NO_SAFE_ACTION | HIGH->HIGH | 2 | 1 | none |
