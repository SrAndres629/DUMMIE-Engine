...
| `layers/l1_nervous/ssh_sandbox_wrapper.sh` | Shell | `/usr/bin/bash` | DEFERRED_NO_SAFE_ACTION | `TOOLCHAIN_VALIDATED` | **MEDIUM** | Verify via shellcheck when installed | No syntax errors detected by bash -n |
