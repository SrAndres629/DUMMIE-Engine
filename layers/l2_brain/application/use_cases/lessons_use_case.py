...
from layers.l2_brain.domain.memory.ports import ILedgerAuditPort
...
class CrystallizeLessonsUseCase:
    ...
    def execute_error(
        ...
        self.ledger_audit.update_ontological_map(
            context.locus_x,
            {
    ...
    def execute_ambiguity(
        self, context: SixDimensionalContext, ambiguity: str, plan: str
    ):
