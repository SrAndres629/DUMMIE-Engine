...
def collect_truth(repo_root: str, include_slow: bool = False) -> TruthReport:
    ...
    checks: list[TruthCheck] = [
        ...
        _file_check(
            ...
            "L2",
            "layers/l2_brain/flat_brain/model_router.py",
        ),
        _file_check(
            repo,
            "l2.model_discovery.file",
            "L2",
            "layers/l2_brain/flat_brain/model_discovery.py",
        ),
        _file_check(
            repo,
            "l2.model_executor.file",
            "L2",
            "layers/l2_brain/flat_brain/model_executor.py",
        ),
        _file_check(
            repo,
            "l2.token_ledger.file",
            "L2",
            "layers/l2_brain/flat_brain/token_cost_ledger.py",
        ),
        _file_check(
            repo,
            "l2.neuron_ledger.file",
            "L2",
            "layers/l2_brain/flat_brain/neuron_ledger.py",
        ),
        _file_check(
            repo,
            "l2.action_graph.file",
            "L2",
            "layers/l2_brain/flat_brain/action_graph.py",
        ),
        _file_check(
            repo,
            "l2.supervisor_protocol.file",
            "L2",
            "layers/l2_brain/flat_brain/supervisor_protocol.py",
        ),
        _file_check(
            repo,
            "l0.dummied.binary",
