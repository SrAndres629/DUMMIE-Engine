...
class EvolutionFlywheelRuntime:
    ...
    def run_evolution_flywheel(
        ...
        reduction = float(
            benchmark.get("summary", {}).get("quantized_reduction_ratio", 0.0) or 0.0
        )
...
def run_evolution_flywheel(
    aiwg_root: str | Path = ".aiwg", write_report: bool = True
) -> EvolutionFlywheelDecision:
