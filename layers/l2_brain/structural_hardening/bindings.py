...
class ContractBindingRegistry:
    ...
    def _initialize_registry(self):
        ...
        # L2 Structural Hardening Pack 2.3 Shadow Candidates
        l2_bindings = [
            ContractBinding(
                path="layers/l2_brain/action_graph.py",
                layer="L2",
                ...
                evidence_refs=["FILE_EXISTS", "IMPORTABLE"],
                action=Recommendation.KEEP_AND_TEST,
                risk_before=RiskLevel.HIGH,
                risk_after=RiskLevel.MEDIUM,
                confidence=0.90,
                notes="Bound during Pack 2.3 batch triage.",
            ),
            ContractBinding(
                path="layers/l2_brain/application/cognitive/use_cases.py",
                layer="L2",
                owner_domain="Cognitive Orchestration",
                structural_class=StructuralClass.ACTIVE_RUNTIME,
                binding_status=BindingStatus.BOUND_ACTIVE_RUNTIME,
                spec_refs=["doc/specs/L2_Brain/12_6d_context_model.md"],
                test_refs=["layers/l2_brain/tests/test_pack2_3_l2_bindings_smoke.py"],
                runtime_refs=[],
                evidence_refs=["FILE_EXISTS", "IMPORTABLE"],
                action=Recommendation.KEEP_AND_TEST,
            ...
            ContractBinding(
                path="layers/l2_brain/ast_indexer.py",
                layer="L2",
            ...
            ContractBinding(
                path="layers/l2_brain/branch_memory.py",
                layer="L2",
                owner_domain="Branch Memory Storage",
                structural_class=StructuralClass.ACTIVE_RUNTIME,
                binding_status=BindingStatus.BOUND_ACTIVE_RUNTIME,
                spec_refs=["doc/specs/L2_Brain/12_6d_context_model.md"],
                test_refs=["layers/l2_brain/tests/test_pack2_3_l2_bindings_smoke.py"],
            ...
            ContractBinding(
                path="layers/l2_brain/cognition/pattern_miner_v2.py",
                layer="L2",
                owner_domain="Pattern Mining",
                structural_class=StructuralClass.ACTIVE_RUNTIME,
                binding_status=BindingStatus.BOUND_ACTIVE_RUNTIME,
                spec_refs=["doc/specs/L2_Brain/12_6d_context_model.md"],
                test_refs=["layers/l2_brain/tests/test_pack2_3_l2_bindings_smoke.py"],
            ...
            ContractBinding(
                path="layers/l2_brain/domain/dtos.py",
                layer="L2",
                owner_domain="Domain DTOs",
                structural_class=StructuralClass.ACTIVE_RUNTIME,
                binding_status=BindingStatus.BOUND_ACTIVE_RUNTIME,
                spec_refs=["doc/specs/L2_Brain/12_6d_context_model.md"],
                test_refs=["layers/l2_brain/tests/test_pack2_3_l2_bindings_smoke.py"],
            ...
            ContractBinding(
                path="layers/l2_brain/domain/hypothesis_service.py",
                layer="L2",
                owner_domain="Dialectical Reasoning",
                structural_class=StructuralClass.ACTIVE_RUNTIME,
                binding_status=BindingStatus.BOUND_ACTIVE_RUNTIME,
                spec_refs=["doc/specs/L2_Brain/12_6d_context_model.md"],
                test_refs=["layers/l2_brain/tests/test_pack2_3_l2_bindings_smoke.py"],
            ...
            ContractBinding(
                path="layers/l2_brain/domain/reasoning_logic.py",
                layer="L2",
                owner_domain="Reasoning Process",
                structural_class=StructuralClass.ACTIVE_RUNTIME,
                binding_status=BindingStatus.BOUND_ACTIVE_RUNTIME,
                spec_refs=["doc/specs/L2_Brain/12_6d_context_model.md"],
                test_refs=["layers/l2_brain/tests/test_pack2_3_l2_bindings_smoke.py"],
            ...
            ContractBinding(
                path="layers/l2_brain/domain/retrieval_service.py",
                layer="L2",
            ...
            ContractBinding(
                path="layers/l2_brain/domain/semantic_ports.py",
                layer="L2",
            ...
            ContractBinding(
                path="layers/l2_brain/entity_voice.py",
                layer="L2",
            ...
            ContractBinding(
                path="layers/l2_brain/evolution_feedback_loop.py",
                layer="L2",
            ...
            ContractBinding(
                path="layers/l2_brain/expansion_policy.py",
                layer="L2",
                owner_domain="State Expansion",
                structural_class=StructuralClass.ACTIVE_RUNTIME,
                binding_status=BindingStatus.BOUND_ACTIVE_RUNTIME,
                spec_refs=["doc/specs/L2_Brain/12_6d_context_model.md"],
                test_refs=["layers/l2_brain/tests/test_pack2_3_l2_bindings_smoke.py"],
            ...
            ContractBinding(
                path="layers/l2_brain/formal_bridge.py",
                layer="L2",
            ...
            ContractBinding(
                path="layers/l2_brain/gateway_contract.py",
                layer="L2",
            ...
            ContractBinding(
                path="layers/l0_overseer/test/overseer_ipc_test.exs",
                layer="L0",
                owner_domain="Overseer OTP Runtime",
                structural_class=StructuralClass.ACTIVE_TEST,
                binding_status=BindingStatus.BOUND_ACTIVE_TEST,
                spec_refs=l0_specs,
                test_refs=[],
                runtime_refs=["layers/l0_overseer/lib/overseer/application.ex"],
                evidence_refs=["FILE_EXISTS"],
                action=Recommendation.KEEP_AND_TEST,
                risk_before=RiskLevel.HIGH,
                risk_after=RiskLevel.LOW,
                confidence=1.0,
                notes="Verified active test for Overseer IPC.",
            ),
            ContractBinding(
                path="layers/l0_overseer/test/test_helper.exs",
                layer="L0",
                owner_domain="Overseer OTP Runtime",
                structural_class=StructuralClass.ACTIVE_TEST,
                binding_status=BindingStatus.BOUND_ACTIVE_TEST,
                ...
                risk_after=RiskLevel.LOW,
                confidence=1.0,
                notes="Standard Elixir test helper script.",
            ),
            ContractBinding(
                path="doc/.deprecated/scratchpad/test_kuzu.py",
                layer="L2",
                owner_domain="Legacy Scratchpad",
                structural_class=StructuralClass.LEGACY,
                binding_status=BindingStatus.MARKED_LEGACY_WITH_EVIDENCE,
                spec_refs=[],
                test_refs=[],
                runtime_refs=[],
                evidence_refs=["FILE_EXISTS"],
                action=Recommendation.NO_ACTION,
                risk_before=RiskLevel.MEDIUM,
                risk_after=RiskLevel.LOW,
                confidence=1.0,
                notes="Frozen legacy scratchpad script.",
            ),
            ContractBinding(
                path="doc/.deprecated/scratchpad/verify_4d_sovereignty.py",
                layer="L2",
                owner_domain="Legacy Scratchpad",
                structural_class=StructuralClass.LEGACY,
                binding_status=BindingStatus.MARKED_LEGACY_WITH_EVIDENCE,
            ...
            ContractBinding(
                path="doc/.deprecated/scratchpad/verify_mcp.py",
                layer="L2",
                owner_domain="Legacy Scratchpad",
                structural_class=StructuralClass.LEGACY,
                binding_status=BindingStatus.MARKED_LEGACY_WITH_EVIDENCE,
            ...
            ContractBinding(
                path="doc/.deprecated/scratchpad/verify_mcp_init.py",
                layer="L2",
                owner_domain="Legacy Scratchpad",
                structural_class=StructuralClass.LEGACY,
                binding_status=BindingStatus.MARKED_LEGACY_WITH_EVIDENCE,
            ...
            ContractBinding(
                path="doc/.deprecated/scratchpad/verify_mcp_stability.py",
                layer="L2",
                owner_domain="Legacy Scratchpad",
                structural_class=StructuralClass.LEGACY,
                binding_status=BindingStatus.MARKED_LEGACY_WITH_EVIDENCE,
            ...
            ContractBinding(
                path="doc/.deprecated/scratchpad/verify_optimization.py",
                layer="L2",
                owner_domain="Legacy Scratchpad",
                structural_class=StructuralClass.LEGACY,
                binding_status=BindingStatus.MARKED_LEGACY_WITH_EVIDENCE,
            ...
            ContractBinding(
                path="doc/.deprecated/scratchpad/verify_sensors.py",
                layer="L2",
                owner_domain="Legacy Scratchpad",
                structural_class=StructuralClass.LEGACY,
                binding_status=BindingStatus.MARKED_LEGACY_WITH_EVIDENCE,
            ...
            ContractBinding(
                path="doc/.deprecated/scratchpad/verify_spec30_fix.py",
                layer="L2",
                owner_domain="Legacy Scratchpad",
                structural_class=StructuralClass.LEGACY,
                binding_status=BindingStatus.MARKED_LEGACY_WITH_EVIDENCE,
            ...
            ContractBinding(
                path="doc/.deprecated/scratchpad/verify_status_final.py",
                layer="L2",
                owner_domain="Legacy Scratchpad",
                structural_class=StructuralClass.LEGACY,
                binding_status=BindingStatus.MARKED_LEGACY_WITH_EVIDENCE,
            ...
            ContractBinding(
                path="doc/.deprecated/scratchpad/verify_tools.py",
                layer="L2",
                owner_domain="Legacy Scratchpad",
                structural_class=StructuralClass.LEGACY,
                binding_status=BindingStatus.MARKED_LEGACY_WITH_EVIDENCE,
        ...
        for binding in l2_bindings:
            self._bindings[binding.path] = binding
