defmodule DUMMIE Engine.V2.TaskResult.Status do
  @moduledoc false
...
defmodule DUMMIE Engine.V2.SovereignContext do
  @moduledoc false
...
defmodule DUMMIE Engine.V2.ValidationRequest do
  @moduledoc false
...
defmodule DUMMIE Engine.V2.ValidationResponse do
  @moduledoc false
  ...
  field :violations, 2, repeated: true, type: DUMMIE Engine.V2.ArchitecturalViolation
  field :health_score, 3, type: :string, json_name: "healthScore"
end

defmodule DUMMIE Engine.V2.ArchitecturalViolation do
  @moduledoc false
...
defmodule DUMMIE Engine.V2.NodeIdentity do
  @moduledoc false
...
defmodule DUMMIE Engine.V2.AgentTask do
  @moduledoc false
  ...
  field :context_anchor, 3, type: DUMMIE Engine.V2.EventId, json_name: "contextAnchor"
  field :payload_ticket, 4, type: DUMMIE Engine.V2.MemoryTicket, json_name: "payloadTicket"
  field :sovereign_ctx, 5, type: DUMMIE Engine.V2.SovereignContext, json_name: "sovereignCtx"
end

defmodule DUMMIE Engine.V2.AgentIntent do
  @moduledoc false
  ...
  field :parent_event, 6, type: DUMMIE Engine.V2.EventId, json_name: "parentEvent"
  field :is_shadow, 7, type: :bool, json_name: "isShadow"
  field :sovereign_ctx, 8, type: DUMMIE Engine.V2.SovereignContext, json_name: "sovereignCtx"
end

defmodule DUMMIE Engine.V2.TaskResult do
  @moduledoc false
  ...
  field :task_id, 1, type: :string, json_name: "taskId"
  field :status, 2, type: DUMMIE Engine.V2.TaskResult.Status, enum: true
  field :output_ticket, 3, type: DUMMIE Engine.V2.MemoryTicket, json_name: "outputTicket"
  field :error_summary, 4, type: :string, json_name: "errorSummary"
  field :tokens_consumed, 5, type: :uint32, json_name: "tokensConsumed"
  field :event_id, 6, type: DUMMIE Engine.V2.EventId, json_name: "eventId"
end

defmodule DUMMIE Engine.V2.ThoughtTrace do
  @moduledoc false
  ...
  field :current_position, 4, type: DUMMIE Engine.V2.EventId, json_name: "currentPosition"
end

defmodule DUMMIE Engine.V2.ExecutionRequest.EnvVarsEntry do
  @moduledoc false
...
defmodule DUMMIE Engine.V2.ExecutionRequest do
  @moduledoc false
  ...
  field :env_vars, 3,
    repeated: true,
    type: DUMMIE Engine.V2.ExecutionRequest.EnvVarsEntry,
    json_name: "envVars",
    map: true
...
defmodule DUMMIE Engine.V2.ExecutionResponse do
  @moduledoc false
...
defmodule DUMMIE Engine.V2.SkillData do
  @moduledoc false
...
defmodule DUMMIE Engine.V2.VectorClockRequest do
  @moduledoc false
...
defmodule DUMMIE Engine.V2.VectorClockResponse.ClockMapEntry do
  @moduledoc false
...
defmodule DUMMIE Engine.V2.VectorClockResponse do
  @moduledoc false
  ...
  field :clock_map, 1,
    repeated: true,
    type: DUMMIE Engine.V2.VectorClockResponse.ClockMapEntry,
    json_name: "clockMap",
    map: true
end
