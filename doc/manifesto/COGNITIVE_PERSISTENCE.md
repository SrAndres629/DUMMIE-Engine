...
- vision
claims:
- id: COGNITIVE_PERSISTENCE-file-valid
  description: Spec file 'COGNITIVE_PERSISTENCE.md' exists, parses valid YAML frontmatter,
    and is not empty.
  verify_cmd: python3 -c "import yaml; d=yaml.safe_load(open('/media/datasets/DUMMIE
    Engine/doc/manifesto/COGNITIVE_PERSISTENCE.md').read().split('---')[1]); assert
    d, 'empty frontmatter'"
  severity: critical
---
