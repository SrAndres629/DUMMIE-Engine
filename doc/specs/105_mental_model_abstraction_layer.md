...
claims:
- id: 105_mental_model_abstraction_layer-file-valid
  description: Spec file '105_mental_model_abstraction_layer.md' exists, parses valid
    YAML frontmatter, and is not empty.
  verify_cmd: python3 -c "import yaml; d=yaml.safe_load(open('/media/datasets/DUMMIE
    Engine/doc/specs/105_mental_model_abstraction_layer.md').read().split('---')[1]);
