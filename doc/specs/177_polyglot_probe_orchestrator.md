...
claims:
- id: 177_polyglot_probe_orchestrator-file-valid
  description: Spec file '177_polyglot_probe_orchestrator.md' exists, parses valid
    YAML frontmatter, and is not empty.
  verify_cmd: python3 -c "import yaml; d=yaml.safe_load(open('/media/datasets/DUMMIE
    Engine/doc/specs/177_polyglot_probe_orchestrator.md').read().split('---')[1]);
...
## Physical Evidence
- Core module: `layers/l2_brain/cognition/polyglot_probe_orchestrator.py`
