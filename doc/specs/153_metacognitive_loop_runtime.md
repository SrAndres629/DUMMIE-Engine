...
claims:
- id: 153_metacognitive_loop_runtime-file-valid
  description: Spec file '153_metacognitive_loop_runtime.md' exists, parses valid
    YAML frontmatter, and is not empty.
  verify_cmd: python3 -c "import yaml; d=yaml.safe_load(open('/media/datasets/DUMMIE
    Engine/doc/specs/153_metacognitive_loop_runtime.md').read().split('---')[1]);
