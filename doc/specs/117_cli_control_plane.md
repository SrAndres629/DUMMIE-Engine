...
claims:
- id: 117_cli_control_plane-file-valid
  description: Spec file '117_cli_control_plane.md' exists, parses valid YAML frontmatter,
    and is not empty.
  verify_cmd: python3 -c "import yaml; d=yaml.safe_load(open('/media/datasets/DUMMIE
    Engine/doc/specs/117_cli_control_plane.md').read().split('---')[1]); assert d,
    'empty frontmatter'"
  severity: critical
---
