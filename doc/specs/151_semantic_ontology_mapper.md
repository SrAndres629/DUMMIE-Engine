...
claims:
- id: 151_semantic_ontology_mapper-file-valid
  description: Spec file '151_semantic_ontology_mapper.md' exists, parses valid YAML
    frontmatter, and is not empty.
  verify_cmd: python3 -c "import yaml; d=yaml.safe_load(open('/media/datasets/DUMMIE
    Engine/doc/specs/151_semantic_ontology_mapper.md').read().split('---')[1]); assert
    d, 'empty frontmatter'"
  severity: critical
---
