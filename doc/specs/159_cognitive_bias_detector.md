...
claims:
- id: 159_cognitive_bias_detector-file-valid
  description: Spec file '159_cognitive_bias_detector.md' exists, parses valid YAML
    frontmatter, and is not empty.
  verify_cmd: python3 -c "import yaml; d=yaml.safe_load(open('/media/datasets/DUMMIE
    Engine/doc/specs/159_cognitive_bias_detector.md').read().split('---')[1]); assert
    d, 'empty frontmatter'"
  severity: critical
---
