...
claims:
- id: 30_floating_sessions-file-valid
  description: Spec file '30_floating_sessions.md' exists, parses valid YAML frontmatter,
    and is not empty.
  verify_cmd: python3 -c "import yaml; d=yaml.safe_load(open('/media/datasets/DUMMIE
    Engine/doc/specs/L1_Nervous/30_floating_sessions.md').read().split('---')[1]);
