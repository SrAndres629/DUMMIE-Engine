...
claims:
- id: 15_mcp_sidecar_isolation-file-valid
  description: Spec file '15_mcp_sidecar_isolation.md' exists, parses valid YAML frontmatter,
    and is not empty.
  verify_cmd: python3 -c "import yaml; d=yaml.safe_load(open('/media/datasets/DUMMIE
    Engine/doc/specs/L1_Nervous/15_mcp_sidecar_isolation.md').read().split('---')[1]);
