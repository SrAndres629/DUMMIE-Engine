...
claims:
- id: dummie_brain_v1.spec-file-valid
  description: Spec file 'dummie_brain_v1.spec.md' exists, parses valid YAML frontmatter,
    and is not empty.
  verify_cmd: python3 -c "import yaml; d=yaml.safe_load(open('/media/datasets/DUMMIE
    Engine/doc/specs/L1_Nervous/dummie_brain_v1.spec.md').read().split('---')[1]);
