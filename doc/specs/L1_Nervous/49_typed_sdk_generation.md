...
claims:
- id: 49_typed_sdk_generation-file-valid
  description: Spec file '49_typed_sdk_generation.md' exists, parses valid YAML frontmatter,
    and is not empty.
  verify_cmd: python3 -c "import yaml; d=yaml.safe_load(open('/media/datasets/DUMMIE
    Engine/doc/specs/L1_Nervous/49_typed_sdk_generation.md').read().split('---')[1]);
