...
claims:
- id: 82_long_running_mission_runtime-file-valid
  description: Spec file '82_long_running_mission_runtime.md' exists, parses valid
    YAML frontmatter, and is not empty.
  verify_cmd: python3 -c "import yaml; d=yaml.safe_load(open('/media/datasets/DUMMIE
    Engine/doc/specs/L2_Brain/82_long_running_mission_runtime.md').read().split('---')[1]);
