...
claims:
- id: 81_phase_ledger-file-valid
  description: Spec file '81_phase_ledger.md' exists, parses valid YAML frontmatter,
    and is not empty.
  verify_cmd: python3 -c "import yaml; d=yaml.safe_load(open('/media/datasets/DUMMIE
    Engine/doc/specs/L2_Brain/81_phase_ledger.md').read().split('---')[1]); assert
    d, 'empty frontmatter'"
  severity: critical
---
# Phase Ledger
