...
claims:
- id: 41_wordline_sovereignty-file-valid
  description: Spec file '41_wordline_sovereignty.md' exists, parses valid YAML frontmatter,
    and is not empty.
  verify_cmd: python3 -c "import yaml; d=yaml.safe_load(open('/media/datasets/DUMMIE
    Engine/doc/specs/L2_Brain/41_wordline_sovereignty.md').read().split('---')[1]);
