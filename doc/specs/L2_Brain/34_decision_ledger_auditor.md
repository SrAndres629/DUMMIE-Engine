...
claims:
- id: 34_decision_ledger_auditor-file-valid
  description: Spec file '34_decision_ledger_auditor.md' exists, parses valid YAML
    frontmatter, and is not empty.
  verify_cmd: python3 -c "import yaml; d=yaml.safe_load(open('/media/datasets/DUMMIE
    Engine/doc/specs/L2_Brain/34_decision_ledger_auditor.md').read().split('---')[1]);
...
## Physical Evidence
- `doc/specs/L2_Brain/34_decision_ledger_auditor.md`
- `doc/specs/L2_Brain/34_decision_ledger_auditor.feature`
- `doc/specs/L2_Brain/34_decision_ledger_auditor.rules.json`
