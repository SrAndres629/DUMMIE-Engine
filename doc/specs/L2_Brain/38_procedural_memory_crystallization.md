...
claims:
- id: 38_procedural_memory_crystallization-file-valid
  description: Spec file '38_procedural_memory_crystallization.md' exists, parses
    valid YAML frontmatter, and is not empty.
  verify_cmd: python3 -c "import yaml; d=yaml.safe_load(open('/media/datasets/DUMMIE
    Engine/doc/specs/L2_Brain/38_procedural_memory_crystallization.md').read().split('---')[1]);
