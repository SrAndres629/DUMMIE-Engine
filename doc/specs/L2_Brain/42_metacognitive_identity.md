...
claims:
- id: 42_metacognitive_identity-file-valid
  description: Spec file '42_metacognitive_identity.md' exists, parses valid YAML
    frontmatter, and is not empty.
  verify_cmd: python3 -c "import yaml; d=yaml.safe_load(open('/media/datasets/DUMMIE
    Engine/doc/specs/L2_Brain/42_metacognitive_identity.md').read().split('---')[1]);
...
## Physical Evidence
- `doc/specs/L2_Brain/42_metacognitive_identity.md`
- `doc/specs/L2_Brain/42_metacognitive_identity.feature`
- `doc/specs/L2_Brain/42_metacognitive_identity.rules.json`
