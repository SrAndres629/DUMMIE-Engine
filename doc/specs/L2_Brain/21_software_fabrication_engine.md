...
claims:
- id: 21_software_fabrication_engine-file-valid
  description: Spec file '21_software_fabrication_engine.md' exists, parses valid
    YAML frontmatter, and is not empty.
  verify_cmd: python3 -c "import yaml; d=yaml.safe_load(open('/media/datasets/DUMMIE
    Engine/doc/specs/L2_Brain/21_software_fabrication_engine.md').read().split('---')[1]);
...
## Physical Evidence
- `doc/specs/L2_Brain/21_software_fabrication_engine.md`
- `doc/specs/L2_Brain/21_software_fabrication_engine.feature`
- `doc/specs/L2_Brain/21_software_fabrication_engine.rules.json`
