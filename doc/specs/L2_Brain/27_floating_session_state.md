...
claims:
- id: 27_floating_session_state-file-valid
  description: Spec file '27_floating_session_state.md' exists, parses valid YAML
    frontmatter, and is not empty.
  verify_cmd: python3 -c "import yaml; d=yaml.safe_load(open('/media/datasets/DUMMIE
    Engine/doc/specs/L2_Brain/27_floating_session_state.md').read().split('---')[1]);
