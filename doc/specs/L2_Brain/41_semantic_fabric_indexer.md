...
claims:
- id: 41_semantic_fabric_indexer-file-valid
  description: Spec file '41_semantic_fabric_indexer.md' exists, parses valid YAML
    frontmatter, and is not empty.
  verify_cmd: python3 -c "import yaml; d=yaml.safe_load(open('/media/datasets/DUMMIE
    Engine/doc/specs/L2_Brain/41_semantic_fabric_indexer.md').read().split('---')[1]);
...
## Physical Evidence
- `doc/specs/L2_Brain/41_semantic_fabric_indexer.md`
- `doc/specs/L2_Brain/41_semantic_fabric_indexer.feature`
- `doc/specs/L2_Brain/41_semantic_fabric_indexer.rules.json`
