...
claims:
- id: 121_state_coherence_guard-file-valid
  description: Spec file '121_state_coherence_guard.md' exists, parses valid YAML
    frontmatter, and is not empty.
  verify_cmd: python3 -c "import yaml; d=yaml.safe_load(open('/media/datasets/DUMMIE
    Engine/doc/specs/121_state_coherence_guard.md').read().split('---')[1]); assert
    d, 'empty frontmatter'"
  severity: critical
---
