...
claims:
- id: 26_command_canvas_gui-file-valid
  description: Spec file '26_command_canvas_gui.md' exists, parses valid YAML frontmatter,
    and is not empty.
  verify_cmd: python3 -c "import yaml; d=yaml.safe_load(open('/media/datasets/DUMMIE
    Engine/doc/specs/L6_Skin/26_command_canvas_gui.md').read().split('---')[1]); assert
    d, 'empty frontmatter'"
  severity: critical
---
