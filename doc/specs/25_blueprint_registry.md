...
## Verification
```bash
python3 scripts/validate_specs_docs.py --check doc/specs/25_blueprint_registry.md
```

## Traceability
| Invariant | Evidence | Verification |
| --- | --- | --- |
| Estado permitido | `doc/CORE_SPEC.md` + frontmatter de esta spec | `python3 scripts/validate_specs_docs.py --check doc/specs/25_blueprint_registry.md` |
| Artefactos hermanos presentes | `doc/specs/25_blueprint_registry.feature` y `doc/specs/25_blueprint_registry.rules.json` | `python3 scripts/validate_specs_docs.py --check doc/specs/25_blueprint_registry.md` |
| Evidencia física existente | sección `Physical Evidence` | `python3 scripts/validate_specs_docs.py --check doc/specs/25_blueprint_registry.md` |
