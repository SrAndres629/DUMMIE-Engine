...
claims:
- id: 33_persistent_personality_mood-file-valid
  description: Spec file '33_persistent_personality_mood.md' exists, parses valid
    YAML frontmatter, and is not empty.
  verify_cmd: python3 -c "import yaml; d=yaml.safe_load(open('/media/datasets/DUMMIE
    Engine/doc/specs/L0_Overseer/33_persistent_personality_mood.md').read().split('---')[1]);
...
- `doc/specs/L0_Overseer/33_persistent_personality_mood.feature`
- `doc/specs/L0_Overseer/33_persistent_personality_mood.rules.json`
