...
claims:
- id: 03_polyglot_architecture-file-valid
  description: Spec file '03_polyglot_architecture.md' exists, parses valid YAML frontmatter,
    and is not empty.
  verify_cmd: python3 -c "import yaml; d=yaml.safe_load(open('/media/datasets/DUMMIE
    Engine/doc/specs/L0_Overseer/03_polyglot_architecture.md').read().split('---')[1]);
...
- `doc/specs/L0_Overseer/03_polyglot_architecture.feature`
- `doc/specs/L0_Overseer/03_polyglot_architecture.rules.json`
