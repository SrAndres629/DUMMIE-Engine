...
claims:
- id: 46_sovereign_daemon_dummied-file-valid
  description: Spec file '46_sovereign_daemon_dummied.md' exists, parses valid YAML
    frontmatter, and is not empty.
  verify_cmd: python3 -c "import yaml; d=yaml.safe_load(open('/media/datasets/DUMMIE
    Engine/doc/specs/L0_Overseer/46_sovereign_daemon_dummied.md').read().split('---')[1]);
