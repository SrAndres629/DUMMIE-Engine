...
claims:
- id: 42_proactive_heartbeat_protocol-file-valid
  description: Spec file '42_proactive_heartbeat_protocol.md' exists, parses valid
    YAML frontmatter, and is not empty.
  verify_cmd: python3 -c "import yaml; d=yaml.safe_load(open('/media/datasets/DUMMIE
    Engine/doc/specs/L0_Overseer/42_proactive_heartbeat_protocol.md').read().split('---')[1]);
