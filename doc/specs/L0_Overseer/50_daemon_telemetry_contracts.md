...
claims:
- id: 50_daemon_telemetry_contracts-file-valid
  description: Spec file '50_daemon_telemetry_contracts.md' exists, parses valid YAML
    frontmatter, and is not empty.
  verify_cmd: python3 -c "import yaml; d=yaml.safe_load(open('/media/datasets/DUMMIE
    Engine/doc/specs/L0_Overseer/50_daemon_telemetry_contracts.md').read().split('---')[1]);
