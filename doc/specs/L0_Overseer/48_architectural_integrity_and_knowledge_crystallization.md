...
- industrial_sdd
claims:
- id: 48_architectural_integrity_and_knowledge_crystallization-file-valid
  description: Spec file '48_architectural_integrity_and_knowledge_crystallization.md'
    exists, parses valid YAML frontmatter, and is not empty.
  verify_cmd: python3 -c "import yaml; d=yaml.safe_load(open('/media/datasets/DUMMIE
    Engine/doc/specs/L0_Overseer/48_architectural_integrity_and_knowledge_crystallization.md').read().split('---')[1]);
