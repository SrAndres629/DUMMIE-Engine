...
claims:
- id: 32_multiverse_compression_necro_learning-file-valid
  description: Spec file '32_multiverse_compression_necro_learning.md' exists, parses
    valid YAML frontmatter, and is not empty.
  verify_cmd: python3 -c "import yaml; d=yaml.safe_load(open('/media/datasets/DUMMIE
    Engine/doc/specs/L5_Muscle/32_multiverse_compression_necro_learning.md').read().split('---')[1]);
...
## Physical Evidence
- `doc/specs/L5_Muscle/32_multiverse_compression_necro_learning.md`
- `doc/specs/L5_Muscle/32_multiverse_compression_necro_learning.feature`
- `doc/specs/L5_Muscle/32_multiverse_compression_necro_learning.rules.json`
