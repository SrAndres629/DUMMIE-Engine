...
claims:
- id: 113_prompt_frame_builder-file-valid
  description: Spec file '113_prompt_frame_builder.md' exists, parses valid YAML frontmatter,
    and is not empty.
  verify_cmd: python3 -c "import yaml; d=yaml.safe_load(open('/media/datasets/DUMMIE
    Engine/doc/specs/113_prompt_frame_builder.md').read().split('---')[1]); assert
    d, 'empty frontmatter'"
  severity: critical
---
