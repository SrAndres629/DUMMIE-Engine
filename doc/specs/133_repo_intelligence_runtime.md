...
claims:
- id: 133_repo_intelligence_runtime-file-valid
  description: Spec file '133_repo_intelligence_runtime.md' exists, parses valid YAML
    frontmatter, and is not empty.
  verify_cmd: python3 -c "import yaml; d=yaml.safe_load(open('/media/datasets/DUMMIE
    Engine/doc/specs/133_repo_intelligence_runtime.md').read().split('---')[1]); assert
    d, 'empty frontmatter'"
  severity: critical
---
