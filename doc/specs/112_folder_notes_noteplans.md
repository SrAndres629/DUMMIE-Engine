...
claims:
- id: 112_folder_notes_noteplans-file-valid
  description: Spec file '112_folder_notes_noteplans.md' exists, parses valid YAML
    frontmatter, and is not empty.
  verify_cmd: python3 -c "import yaml; d=yaml.safe_load(open('/media/datasets/DUMMIE
    Engine/doc/specs/112_folder_notes_noteplans.md').read().split('---')[1]); assert
    d, 'empty frontmatter'"
  severity: critical
---
