...
claims:
- id: 124_sdd_tdd_mission_planner-file-valid
  description: Spec file '124_sdd_tdd_mission_planner.md' exists, parses valid YAML
    frontmatter, and is not empty.
  verify_cmd: python3 -c "import yaml; d=yaml.safe_load(open('/media/datasets/DUMMIE
    Engine/doc/specs/124_sdd_tdd_mission_planner.md').read().split('---')[1]); assert
    d, 'empty frontmatter'"
  severity: critical
---
